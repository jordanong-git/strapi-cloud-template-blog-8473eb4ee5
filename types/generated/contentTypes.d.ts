...
export interface ApiDifficultyDifficulty extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Managed difficulty taxonomy for IP vault content.';
  ...
  attributes: {
    ...
    level_number: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    lmsUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://app.realms.oljmedia.com/'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiIpAssetIpAsset extends Struct.CollectionTypeSchema {
...
export interface ApiIpAuditLogIpAuditLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    action: Schema.Attribute.Enumeration<
      ['generate_questions', 'generate_worksheet', 'asset_url']
    > &
      Schema.Attribute.Required;
    asset_id: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    query_params: Schema.Attribute.JSON;
    request_id: Schema.Attribute.String;
    requested_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
    requested_count: Schema.Attribute.Integer;
...
export interface ApiIpQuestionIpQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accepted_answers: Schema.Attribute.JSON;
    ...
    > &
      Schema.Attribute.Private;
    marking_rubric: Schema.Attribute.RichText;
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    assets: Schema.Attribute.Relation<'manyToMany', 'api::ip-asset.ip-asset'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
